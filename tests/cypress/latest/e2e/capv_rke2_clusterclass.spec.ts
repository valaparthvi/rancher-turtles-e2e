...
Cypress.config();
describe('Import CAPV RKE2 Class-Cluster', {tags: ['@vsphere', '@capvr']}, () => {
  ...
  context('[SETUP]', () => {
    ...
    qase(275, it('Create VSphere CAPIProvider & VSphereClusterIdentity', () => {
  ...
  context('[CLUSTER-OPERATIONS]', () => {
    ...
    qase(534, it('Check for any errors in Turtles logs', () => {
